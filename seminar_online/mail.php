...
$site_top = "http://az-one.biz/";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "az-one.seminar@azest-gr.co.jp,hagiwara@azest-gr.co.jp";
...
$Referer_check_domain = "az-one.biz,az-one.sakura.ne.jp/";
...
$subject = "AZ-ONE 無料個別オンラインセミナー申込み";
...
$require = array('セミナー選択','第1希望日','第1希望時間','ふりがな','お名前','Email');
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://az-one.biz/" target="_blank">- AZ-ONE -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
