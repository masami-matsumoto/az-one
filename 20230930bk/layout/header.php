...
<header>
    ...
    <link rel="stylesheet" media="all" type="text/css" href="../css/simulation.css" />
    <!-- ※drawerのスタイル -->
    <!-- ※drawerのスタイル -->
    ...
    <div class="inner">
        <h1 class="pcView"><a href="/"><img src="../img/common/logo.svg" width="80%" height="" alt="AZ-ONE" /></a></h1>
        <h1 class="spView"><a href="/"><img src="../img/common/logo.svg" width="318" height="60" alt="AZ-ONE" /></a></h1>
        <nav class="pcView">
            <ul>
